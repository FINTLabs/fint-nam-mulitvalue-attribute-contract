...
//                arrayList: new ArrayList<UserAuthority>
//        )
//    }
//
//    def "Lists are equal"() {
...
//
//        when:
//        def listsIsEqual = updateUserStoreBySamlResponseContract.compareStringArrays(list1.toArray() as String[], list2.toArray() as String[])
//
//        then:
//        listsIsEqual
//
